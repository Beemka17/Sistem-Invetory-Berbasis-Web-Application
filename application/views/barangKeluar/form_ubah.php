                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group"><label>Jumlah Keluar</label>
                             ...
                             <div class="form-group"><label>Delivery</label>
                                <input class="form-control" name="delivery" type="text" placeholder="" value="<?= $d->delivery?>">
                            </div>

                             <!-- Customer -->
                             <div class="form-group"><label>Customer</label>
                                <input class="form-control" name="customer" type="text" placeholder="" value="<?= $d->customer?>">
                            </div>
