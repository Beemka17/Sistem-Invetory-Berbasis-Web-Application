...
<head>
    ...
    <title>INVENTORY HMS | <?= $title ?></title>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <p style="padding-top:23.2px; font-size:13px; font-style:italic; font-weight: bold; color: #CC0000; padding-right:20px;">
                            CV Hamta Makmur Sejahtera
                        </p>
