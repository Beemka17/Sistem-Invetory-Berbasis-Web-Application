...
<h2 style="padding-left:30px;">Laporan Stok Masuk</h2>
<table class="table" id="dtHorizontalExample" width="100%" cellspacing="0">
                        ...
                        <tbody id="tbody">
                            ...
                            <tr>
                                <td><?= $no++ ?>.</td>
                                <td><?= $bk->id_barang_masuk ?></td>
                                <td><?= tgl_indo($bk->tgl_masuk) ?></td>
                                <td><?= $bk->nama_barang ?></td>
                                <td><span class="badge badge-danger"> <i class="fa fa-minus"></i> <?= $bk->jumlah_masuk ?></span></td>
                                <td><?= $bk->id_supplier ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
