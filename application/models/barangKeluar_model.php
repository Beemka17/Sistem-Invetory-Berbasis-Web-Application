...
class barangKeluar_model extends ci_model{
	...
	{
		$this->db->select('barang_keluar.tgl_keluar, barang_keluar.id_barang_keluar, barang_keluar.jumlah_keluar, barang_keluar.delivery, barang_keluar.customer, barang.nama_barang');
